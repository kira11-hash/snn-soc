...
# ---------------------------------------------------------------------------
# Define SYNTHESIS (guards behavioral-only blocks in RTL)
# Pass INSTR_INIT_FILE as a generic parameter override via set_property
# ---------------------------------------------------------------------------
...
synth_design \
    ...
    -include_dirs [list $repo_root/rtl/top] \
    -verbose
