...
# ratio 专项扫描：聚焦低阈值区间，避免漏掉 0.02 附近最优点
THRESHOLD_RATIO_CANDIDATES = [0.01, 0.012, 0.015, 0.018, 0.020, 0.025, 0.030, 0.040, 0.050, 0.080, 0.100]
