...
// - 桥接层支持 AW/W 错拍（1-entry pending），但仅支持单笔未完成事务
// - 对未映射或非 4B 对齐访问，桥接层返回 DECERR
//
// 【升级路径】
...
interface axi_lite_if (
  ...
  logic [1:0]  BRESP;    // 响应码：2'b00=OKAY，2'b11=DECERR
  ...
  logic [1:0]  RRESP;    // 响应码：2'b00=OKAY，2'b11=DECERR
