...
| **ZCU102** | **Zynq US+ ZU9EG** | **274,080** | **912×36Kb** | **已有** | **最佳（详见 4.3 节）** |
...
| BRAM 36Kb | 912 块 (32.1 Mb) | 4~6 块 (18Kb 当量) | >150× |
...
|----------|----------------|--------|
| UART TX 调试输出 | CP2108 USB-UART 桥（4 通道，micro-USB） | **直接可用**（PL 侧 UART 引脚通过 EMIO 或 PMOD 引出） |
