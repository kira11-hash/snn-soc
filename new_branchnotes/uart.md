...
| `0x04` | `STATUS` | `[0]=tx_busy` | RO | 1=发送中，0=空闲 |
| `0x08` | `CTRL` | `[15:0]=baud_div` | R/W | 波特率分频，默认对应 115200@100MHz |
| `0x0C` | `RXDATA` | `[7:0]` | RO | V1 占位，返回 0 |
...
4. T4：发送 `0xFF` 并解码校验
5. T5：发送 `0x00` 并解码校验
6. T6：发送中读取 `STATUS.tx_busy=1`，发送后为 `0`
7. T7：忙时写入忽略，空闲后再发字节验证
